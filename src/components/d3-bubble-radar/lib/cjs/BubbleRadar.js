...
var BubbleRadar = /** @class */ (function (_super) {
    ...
    function BubbleRadar(props) {
        ...
        var _e = props.dimensions, width = _e.width, height = _e.height, margin = _e.margin;
        var newWidth = width + ((_a = margin.left) !== null && _a !== void 0 ? _a : 0) + ((_b = margin.right) !== null && _b !== void 0 ? _b : 0);
        var newHeight = height + ((_c = margin.top) !== null && _c !== void 0 ? _c : 0) + ((_d = margin.bottom) !== null && _d !== void 0 ? _d : 0);
        _this.state = {
            width: newWidth,
            height: newHeight,
            data: props.data
        ...
        _this.scaleRadius = d3
            .scaleLinear()
            .domain([
            d3.min(props.data, function (item) { return item.total; }),
            d3.max(props.data, function (item) { return item.total; }),
        ])
            .range([10, 25]);
        return _this;
    }
    ...
    BubbleRadar.prototype.shouldComponentUpdate = function (nextProps) {
        if (!this.compareObject(nextProps.data, this.props.data)) {
            ...
            this.scaleRadius = d3
                .scaleLinear()
                .domain([
                d3.min(nextProps.data, function (item) { return item.total; }),
                d3.max(nextProps.data, function (item) { return item.total; }),
            ])
                .range([10, 25]);
            svgEl.selectAll("*").remove();
            this.drawRing(svgEl);
    ...
    BubbleRadar.prototype.drawBubble = function (svgEl) {
        ...
        var circles = svgEl
            .selectAll("circle")
            .data(this.cloneObject(this.props.data)
            .map(function (item) {
            var _a;
            item.radian =
                ((_a = item.subCategoryIndex) !== null && _a !== void 0 ? _a : 0) * _this.table22.vLookup(item.type, 3);
            return item;
        })
            ...
            .attr("r", 0)
            .attr("fill", function (item) { return _this.color(item.impact); })
        ...
        circles
            ...
            .duration(1000)
            .attr("fill-opacity", 1)
            .attr("r", function (item) { return _this.scaleRadius(item.total); })
            .attr("stroke-width", 2);
    };
    BubbleRadar.prototype.drawRing = function (svgEl) {
        ...
        svgEl
            ...
            .style("stroke", "#3a9593")
            .style("fill", "none")
            .attr("r", function (d) { return _this.unit(d + 1); })
            .attr("cx", this.state.height / 2)
            .attr("cy", this.state.height / 2)
            .attr("stroke-width", function (d) { return d * 2 + 1; });
        svgEl
            .append("line")
            .style("stroke", "#3a9593")
    ...
    BubbleRadar.prototype.render = function () {
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("div", { className: "bubble-container" },
                react_1.default.createElement("span", { className: "people-and-process" },
                    "People ",
                    react_1.default.createElement("br", null),
                    " and ",
                    react_1.default.createElement("br", null),
                    " Process"),
                react_1.default.createElement("span", { className: "data-and-access" },
                    "Data ",
                    react_1.default.createElement("br", null),
                    " and ",
                    react_1.default.createElement("br", null),
                    " Access"),
                react_1.default.createElement("span", { className: "asset-and-asset" }, "Asset"),
                react_1.default.createElement("span", { className: "technology" }, "Technology"),
                react_1.default.createElement("div", { className: "impact-container" },
                    react_1.default.createElement("span", null, "Impact"),
                    react_1.default.createElement("div", { className: "impact-item" },
                    ...
                    react_1.default.createElement("div", { className: "impact-item" },
                        ...
                        "  ",
                        " 5")),
                react_1.default.createElement("h1", { className: "title" }, "Risk Radar"),
                react_1.default.createElement("div", { className: "svg-container" },
                    react_1.default.createElement("svg", { ref: this.svgRef, width: this.state.width, height: this.state.height })))));
    };
